        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                    ...
                    <?php } else { ?>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="">Welcome <?=$_SESSION['user_name']; ?></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="carousel-inner">
            <div class="landing carousel-item active">
                ...
                <div class="content carousel-caption d-none d-md-block">
                    ...
                    <a class="btn btn-outline-light btn-lg p-2 fs-2 w-25" href="booking.php">Book now <span
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="details d-flex justify-content-between ">
                            <a href="booking.php" class="btn btn-primary h-fit-content">Book Now!</a>
