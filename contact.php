            ...
            <div class="form-message w-75 m-auto p-5 text-center mt-3">
                ...
                <form action="">
                    <div class="name-email py-3 d-flex justify-content-center align-items-center gap-5">
                        <input type="text" name="" placeholder="Your Name" class="w-100 border p-3">
                        <input type="email" name="" placeholder="Your Email" class="w-100 border p-3">
                    </div>
                    <div class="py-3">
                        <input type="text" name="" placeholder="Subject" class="w-100 border p-3">
                    </div>
                    <div class="py-3">
                        <textarea class="w-100 p-3" name="" placeholder="Your Message"></textarea>
                    </div>
                </form>
            </div>
